...
class VerifyEmailController {
    ...
    public function sendVerificationCode($email) {
        ...
        $stmt = Connection::connect()->prepare("SELECT * FROM usuario WHERE correoUsuario = :email");
        ...
        $updateStmt = Connection::connect()->prepare("UPDATE usuario SET token_password = :token, expired_session = :expiration WHERE correoUsuario = :email");
        ...
        if ($this->sendEmail($email, $verificationCode)) {
    ...
    private function sendEmail($email, $verificationCode) {
        ...
        try {
            ...
            $mail->Body = $this->getEmailTemplate($verificationCode);
